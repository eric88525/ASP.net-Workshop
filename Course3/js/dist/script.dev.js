...
$(document).ready(function () {
  ...
  $("#book_grid").kendoGrid((_$$kendoGrid = {
    ...
    editable: true,
    sortable: true
  }, _defineProperty(_$$kendoGrid, "editable", true), _defineProperty(_$$kendoGrid, "editable", "inline"), _defineProperty(_$$kendoGrid, "filterable", true), _defineProperty(_$$kendoGrid, "pageable", true), _defineProperty(_$$kendoGrid, "batch", true), _defineProperty(_$$kendoGrid, "pageable", {
    input: true,
    numeric: false
  }), _defineProperty(_$$kendoGrid, "columns", [{
    field: "BookId",
    title: "書籍編號",
    width: "10%"
  }, {
    ...
    command: {
      ...
      click: function click(e) {
        ...
        e.preventDefault(); // e.target is the DOM element representing the button
